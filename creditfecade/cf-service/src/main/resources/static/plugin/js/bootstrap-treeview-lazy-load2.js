...
;(function ($, window, document, undefined) {
	...
	/*
	 * Recurse the tree structure and ensure all nodes have valid initial
	 * states. User defined states will be preserved. For performance we also
	 * take this opportunity to index nodes in a flattened ordered structure
	 */
	...
	// data attribute nodeid, which is used to lookup the node in the flattened
	// structure.
	...
	Tree.prototype._setSelected = function (node, state, options) {
		...
		if (state) {
			...
			// If preventUnselect true + only one remaining selection, disable
			// unselect
	...
	Tree.prototype._setChecked = function (node, state, options) {
		...
		if (state) {
			...
			// Optionally trigger event, partially checked is technically
			// unchecked
	 ...
	 * 
	 * @param {String}
	 *            pattern - A pattern to match against a given field
	...
	/**
	 * Returns parent nodes for given nodes, if valid otherwise returns
	 * undefined.
	 * 
	 * @param {Array}
	...
	/**
	 * Returns an array of sibling nodes for given nodes, if valid otherwise
	 * returns undefined.
	 * 
	 * @param {Array}
	 *            nodes - An array of nodes
...
Tree.prototype.setAddNode = function (node, options) {
	...
	/**
	 * Toggles a node selected state; selecting if unselected, unselecting if
	 * selected.
	 * 
	 * @param {Array}
	 *            nodes - An array of nodes
	...
	/**
	 * Toggles a node's expanded state; collapsing if expanded, expanding if
	 * collapsed.
	 * 
	 * @param {Array}
	 *            nodes - An array of nodes
	...
	/**
	 * Toggles a node's checked state; checking if unchecked, unchecking if
	 * checked.
	 * 
	 * @param {Array}
	 *            nodes - An array of nodes
	...
	/**
	 * Saves the current state of checkboxes as default, cleaning up any
	 * highlighted changes
	 */
	...
	/**
	 * Toggles a node's disabled state; disabling is enabled, enabling if
	 * disabled.
	 * 
	 * @param {Array}
	 *            nodes - An array of nodes
	...
	/**
	 * Recursive find for retrieving nested attributes values All values are
	 * return as strings, unless invalid
	 * 
	 * @param {Object}
