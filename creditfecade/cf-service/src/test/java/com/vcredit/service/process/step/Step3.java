 ...
 * @Date 2018/7/3
 */
public class Step3 extends AssembleStep<DefaultChannelParam> {

    Logger logger = LoggerFactory.getLogger(Step3.class);
    private final String key = Step3.class.getName();

    public Step3(AfterStepCallback callback) {
        super(callback);
    }
