 ...
 * @Date 2018/7/3
 */
public class Step4 extends AssembleStep<DefaultChannelParam> {
    Logger logger = LoggerFactory.getLogger(Step4.class);
    private final String key = Step4.class.getName();

    public Step4(AfterStepCallback callback) {
        super(callback);
    }
    @Override
